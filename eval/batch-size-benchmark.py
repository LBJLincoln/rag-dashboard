...
def main():
    parser = argparse.ArgumentParser(description="Batch Size Benchmark")
    parser.add_argument("--pipeline", type=str, default="standard",
                        help="Pipeline to benchmark (standard, graph, quantitative, orchestrator, all)")
    ...
    for pipeline in pipelines:
        ...
        questions = TEST_QUESTIONS[pipeline]
        pipeline_results = []
